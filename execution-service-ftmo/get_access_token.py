...
token for your FTMO (or any cTrader-based broker) account, and lists
...
def main() -> None:
    ...
    print("Opening your browser to authorize this app against your cTrader/FTMO account...")
    ...
    print("\nSuccess! Add these to execution-service-ftmo/.env:\n")
